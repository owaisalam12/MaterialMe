...
public class MainActivity extends AppCompatActivity {
    ...
    private void initializeData() {
        //A TypedArray allows you to store an array of other XML resources. By using a TypedArray,
        // you will be able to obtain the image resources as well as the sports title and information by using indexing in the same loop.
